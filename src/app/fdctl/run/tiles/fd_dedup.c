...
unprivileged_init( fd_topo_t *      topo,
  ...
  fd_tcache_t * tcache = fd_tcache_join( fd_tcache_new( FD_SCRATCH_ALLOC_APPEND( l, FD_TCACHE_ALIGN, FD_TCACHE_FOOTPRINT( tile->dedup.tcache_depth, 8388608) ), tile->dedup.tcache_depth, 0 ) );
